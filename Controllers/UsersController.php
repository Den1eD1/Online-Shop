...
use Project\View;
use Project\ViewModels\LoginInformation;
use Project\ViewModels\RegisterInformation;
use Project\Utilities\Validations;
use Project\Controllers\ProductsController;
...
class UsersController extends Controller
{
    ...
    public function register()
    {
        ...
        if (isset($_POST['username'], $_POST['password'], $_POST['email'])) {
            try {
                ...
                $pass = $_POST['password'];
                $email = $_POST['email'];
                Validations::validatePassword($pass);

                $userModel = new User();
                $userModel->register($user, $pass, $email);
    ...
    public function profile()
    {
        ...
        $userViewModel = new \Project\ViewModels\User(
            $userInfo['username'],
            $userInfo['password'],
            $userInfo['id']
        );
